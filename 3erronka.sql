...
INSERT INTO `balorazioa` VALUES (11,4,'ggg',2,4),(12,4,'ddd',55,3);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `barraka_eguneratu` BEFORE UPDATE ON `barraka` FOR EACH ROW BEGIN
INSERT INTO barrakahistoriko (
        idBarraka, izena, modalitatea, kapazitatea,
        prezioa, irudia, egoera, data
    )
    VALUES (
        OLD.idBarraka, OLD.izena, OLD.modalitatea, OLD.kapazitatea,
        OLD.prezioa, OLD.irudia, "EGUNERATUTA", CURDATE()
    );
END */;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `barraka_ezabatu` BEFORE DELETE ON `barraka` FOR EACH ROW BEGIN
INSERT INTO barrakahistoriko (
        idBarraka, izena, modalitatea, kapazitatea,
        prezioa, irudia, egoera, data
    )
    VALUES (
        OLD.idBarraka, OLD.izena, OLD.modalitatea, OLD.kapazitatea,
        OLD.prezioa, OLD.irudia, "EZABATUTA", CURDATE()
    );
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `bezeroa_eguneratu` BEFORE UPDATE ON `bezeroa` FOR EACH ROW BEGIN
INSERT INTO bezerohistoriko (
        idBezeroa, izena, abizenak, erabiltzailea,
        pasahitza, telefonoa, emaila, egoera, data
    )
    VALUES (
        OLD.idBezeroa, OLD.izena, OLD.abizenak, OLD.erabiltzailea,
        OLD.pasahitza, OLD.telefonoa, OLD.emaila,"EGUNERATUTA", CURDATE()
    );
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `bezeroa_BEFORE_DELETE` BEFORE DELETE ON `bezeroa` FOR EACH ROW BEGIN
 INSERT INTO bezerohistoriko (
        idBezeroa, izena, abizenak, erabiltzailea,
        pasahitza, telefonoa, emaila, egoera, data
    )
    VALUES (
        OLD.idBezeroa, OLD.izena, OLD.abizenak, OLD.erabiltzailea,
        OLD.pasahitza, OLD.telefonoa, OLD.emaila,"EZABATUTA", CURDATE()
    );
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `ekintza_eguneratu` BEFORE UPDATE ON `ekintza` FOR EACH ROW BEGIN
INSERT INTO ekintzahistoriko (
        idEkintza, izenburua, informazioa, data,
        irudia, egoera, data_historiko
    )
    VALUES (
        OLD.idEkintza, OLD.izenburua, OLD.informazioa, OLD.data,
        OLD.irudia, "EGUNERATUTA", CURDATE()
    );
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `ekintza_ezabatu` BEFORE DELETE ON `ekintza` FOR EACH ROW BEGIN
 INSERT INTO ekintzahistoriko (
        idEkintza, izenburua, informazioa, data,
        irudia, egoera, data_historiko
    )
...
INSERT INTO `ekintzahistoriko` VALUES (5,'Barakaldoko Jaia','Musika eta dantza Barakaldon.','2025-08-15','Jaiak_Barakaldo.jpg','EGUNERATUTA','2025-04-08'),(31,'si','ya tu sabe','2020-09-12','jo.jpg','EZABATUTA','2025-04-08'),(32,'Ordiziako festak','Mariren jaitsiera...','2025-07-01',NULL,'EZABATUTA','2025-04-08');
...
INSERT INTO `eskaera` VALUES (29,'Proba','2025-04-07',1),(30,'ddsd','2025-04-08',55);
...
INSERT INTO `eskatu` VALUES (33,6,29),(34,5,29),(35,4,29),(36,4,30),(37,6,30);
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `langilea_eguneratu` BEFORE UPDATE ON `langilea` FOR EACH ROW BEGIN
INSERT INTO langilehistoriko (
        idLangilea, izena, abizenak, erabiltzailea,
        pasahitza, telefonoa, emaila, kargua, egoera, data
    )
    VALUES (
        OLD.idLangilea, OLD.izena, OLD.abizenak, OLD.erabiltzailea,
        OLD.pasahitza, OLD.telefonoa, OLD.emaila, OLD.kargua,"EGUNERATUTA", CURDATE()
    );
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `langilea_ezabatu` BEFORE DELETE ON `langilea` FOR EACH ROW BEGIN
 INSERT INTO langilehistoriko (
        idLangilea, izena, abizenak, erabiltzailea,
        pasahitza, telefonoa, emaila, kargua, egoera, data
    )
    VALUES (
        OLD.idLangilea, OLD.izena, OLD.abizenak, OLD.erabiltzailea,
        OLD.pasahitza, OLD.telefonoa, OLD.emaila, OLD.kargua,"EZABATUTA", CURDATE()
    );
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
INSERT INTO `zalantza` VALUES (1,'sdfdsfsdf',NULL,'2025-04-08',1,31),(2,'Nola egin dezaket beldurra ez izateko?',NULL,'2025-04-08',1,31);
...
-- Dump completed on 2025-04-09  8:52:21
